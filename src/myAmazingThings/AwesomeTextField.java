...
public class AwesomeTextField extends SuperField implements Runnable {
	...
	public AwesomeTextField(String placeHolderValue, String errorMessageValue, int barWidthValue, KeyListener keyListener) {
